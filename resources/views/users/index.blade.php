                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        @if($user->roles)
                                            @foreach($user->roles as $role)
                                                <span class="inline-flex items-center rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-600/20 mr-1">
                                                    {{ $role->name }}
                                                </span>
                                            @endforeach
                                        @endif
