        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <form method="POST" action="{{ route('roles.store') }}">
                    ...
                    <div class="mb-6">
                        <h2 class="text-xl font-semibold text-gray-800">{{ __('Buat Role Baru') }}</h2>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Contoh: Admin, Editor, Operator, Pengunjung</p>
                        @error('name')
