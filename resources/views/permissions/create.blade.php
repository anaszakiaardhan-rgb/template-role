        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <form method="POST" action="{{ route('permissions.store') }}">
                    ...
                    <div class="mb-6">
                        <h2 class="text-xl font-semibold text-gray-800">{{ __('Create New Permission') }}</h2>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Examples: create-user, edit-post, delete-comment, view-reports</p>
                        @error('name')
